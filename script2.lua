 elseif game.PlaceId == 5293755937 then
    ...
    lib:SetTitle("Z.hub Speed Run Simulator")

    local Farming2 = lib:NewTab("Farming", "This is the auto farming tab.")

    getgenv().autoClick = true
    getgenv().autoRebirth = true

    Farming2:NewToggle("AutoClick",false,function(value)
    ...
    Farming2:NewToggle("AutoRebirth",false,function(value)
        getgenv().autoRebirth = value 
        print("AutoRebirth status:", value)
        if value == true then 
            doRebirth()
        end
    end)
    ...
    visual:NewButton("Full bright, e to toggle",function()

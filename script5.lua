elseif game.PlaceId == 5938036553 then
    ...
    local main = lib:NewTab("Main", "Find the main parts of the script here.")

    main:NewButton("Hitbox extender",function()
    local HitboxSize = Vector3.new(15,15,15) --too big wont work

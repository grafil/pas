    ...
    local Farming3 = lib:NewTab("Farming", "All the farming  you find here!")

    getgenv().autoClick = false

    Farming3:NewButton("High Walkspeed ON (ONLY DO WHILE RUNNNING)",function()
        game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 999999999999999999
    end)

    Farming3:NewButton("High Walkspeed OFF",function()
        game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 25
    end)

    Farming3:NewToggle("AutoClicker",false,function(value)
        getgenv().autoClick = value
        print("AutoClicker status:", value)
        if value == true then
            doClick()
        end
    end)
    ...
    local misc1 = lib:NewTab("Misc", "All the misc you find here!")

    misc1:NewButton("Equip best pets",function()
    ...
    scripthub:NewButton("Open Chat spoofer",function()
        loadstring(game:HttpGet(('https://pastebin.com/raw/djBfk8Li'),true))()
    end)

    local visual = lib:NewTab("Visuals", "This is the universal visuals tab, find all visual effects here.")
